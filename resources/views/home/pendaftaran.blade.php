                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="foto_kk" class="form-control" accept=".pdf,.jpeg,.png,.jpg">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                <label>Ijasah</label>
                                <input type="file" name="ijasah" class="form-control" accept=".pdf,.jpeg,.png,.jpg">
                            </div>
                        </div> -->
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_penghasilan_ayah" class="form-control">
                                    ...
                                    <option value="{{ $item->id }}">
                                        {{ 'Rp ' . number_format($item->penghasilan_ortu, 0, ',', '.') }}
                                    </option>
                                    @empty
                                    <option value="">NO Data</option>
                                    @endforelse
